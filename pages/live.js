  ...
  return (
    <aside className="chatPanel card">
      <div className="chatHead">
        <strong>Chat</strong>
        <a href={pop} target="_blank" rel="noreferrer" className="chatPop">
          Pop-out ↗
        </a>
      </div>
...
export default function Live(props) {
  ...
  const angles = props?.angles || [];   // ✅ now defined
...
<meta name="twitter:image" content={`${SITE_URL}/og-yb-live.png`} />
  ...
  <img
    src="/og-yb-live.png"    // or /og-yb-large.png
  ...
  />
        ...
        <style jsx>{`
          ...
          #tipbar { position:fixed; left:0; right:0; bottom:112px; /* ⬆ raise buttons above ticker */ padding:10px 14px; display:flex; justify-content:center; gap:12px; z-index:60; pointer-events:none }
